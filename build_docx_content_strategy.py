...
INPUT_MD = "client-onboarding/clients/kristen-lemastus-coaching/content-authority-strategy_20260304.md"
OUTPUT_DOCX = "client-onboarding/clients/kristen-lemastus-coaching/kristen-lemastus-coaching_content-authority-strategy_20260304.docx"
...
def add_cover_page(doc):
    ...
    run = cover_title.add_run('CONTENT AUTHORITY STRATEGY™')
    ...
    for line in [
        ...
        r.font.name = 'Calibri'
        r.font.size = Pt(12)
        if 'Authority Systems Group' in line or 'Roger' in line or 'Vivienne' in line:
