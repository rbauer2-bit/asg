...
ASG Marketing | Kentucky Derby Article — Local Contractors
Produced: 2026-03-08
"""
...
INPUT_MD    = os.path.join(BASE_DIR, 'asg_local-contractors_kentucky-derby-article_20260308.md')
OUTPUT_DOCX = os.path.join(BASE_DIR, 'asg_local-contractors_kentucky-derby-article_20260308.docx')

DOCUMENT_TITLE    = "TWO MINUTES. MONTHS OF EVERYTHING."
DOCUMENT_SUBTITLE = "What the Kentucky Derby teaches local contractors about the only kind of marketing that actually works"
AUTHOR_LINE       = "Roger Bauer | Authority Systems Group™"
DATE_LINE         = "May 2026"
...
def add_cover_page(doc):
    # Top accent bar via shaded paragraph
    ...
    for line, bold, color in [
        (AUTHOR_LINE, True, ASG_BLUE),
        (DATE_LINE, False, ASG_CHARCOAL),
        ('', False, ASG_CHARCOAL),
        ('Authority Systems Group™', True, ASG_BLUE),
        ('AuthoritySystemsGroup.com', False, ASG_CHARCOAL),
    ]:
        p = doc.add_paragraph()
