...
Client: Kristen LeMastus Coaching & Consulting
"""
...
INPUT_MD = "client-onboarding/clients/kristen-lemastus-coaching/linkedin-30day-content-pack_20260304.md"
OUTPUT_DOCX = "client-onboarding/clients/kristen-lemastus-coaching/kristen-lemastus-coaching_linkedin-30day-content-pack_20260304.docx"
...
def add_cover_page(doc):
    ...
    run = cover_title.add_run('30-DAY LINKEDIN CONTENT PACK')
    ...
    r = subtitle.add_run('Dopamine Ladder Framework™')
    r.font.name = 'Calibri'
    r.font.size = Pt(18)
    r.font.italic = True
    ...
    r2 = location.add_run('Kristen LeMastus | Louisville, KY')
    r2.font.name = 'Calibri'
    r2.font.size = Pt(16)
    r2.font.color.rgb = ASG_CHARCOAL
    location.paragraph_format.space_after = Pt(36)
    ...
    for line in [
        ...
        r.font.name = 'Calibri'
        r.font.size = Pt(12)
        if 'Authority Systems Group' in line or 'Roger' in line or 'Marcus' in line or 'Cleo' in line:
...
def add_footer(doc):
    ...
    run = footer_para.add_run(
        'Authority Systems Group™ — Confidential. Prepared exclusively for Kristen LeMastus / Kristen LeMastus Coaching & Consulting.'
    )
    run.font.name = 'Calibri'
    run.font.size = Pt(8)
