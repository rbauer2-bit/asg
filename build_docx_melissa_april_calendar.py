...
INPUT_MD = "client-onboarding/clients/melissa-doss-law/outputs/melissa-doss-law_april-2026-marketing-calendar_20260306.md"
OUTPUT_DOCX = "client-onboarding/clients/melissa-doss-law/outputs/melissa-doss-law_april-2026-marketing-calendar_20260306.docx"
...
def add_cover_page(doc):
    ...
    run = cover_title.add_run('APRIL 2026 MARKETING CALENDAR')
    ...
    r = subtitle.add_run('Protect What You\u2019ve Built \u2014 High-Net-Worth Client Attraction')
    r.font.name = 'Calibri'
    r.font.size = Pt(16)
    r.font.italic = True
    ...
    r = firm.add_run('Melissa Doss Law')
    r.font.name = 'Calibri'
    r.font.size = Pt(24)
    r.font.bold = True
    r.font.color.rgb = ASG_CHARCOAL
    ...
    r2 = market.add_run('Florence, Kentucky \u2014 Northern Kentucky / Greater Cincinnati')
    ...
    for line in [
        ...
        'Strategy: Nadia Voss, Strategy Coordinator',
        'Content Coordination: Caleb Navarro, Content Coordinator',
        'Content: Lena Ashby, Calendar Content Writer',
        'Under the direction of Roger Bauer, Director',
        '',
        'April 2026  |  Confidential',
        'Melissa Doss Law \u2014 Prepared exclusively by Authority Systems Group\u2122',
    ]:
        p = doc.add_paragraph()
        ...
        r.font.name = 'Calibri'
        r.font.size = Pt(11)
        if 'Authority Systems Group' in line or 'Roger' in line or 'Sloane' in line or 'Lena' in line or 'Nadia' in line or 'Caleb' in line:
