...
Legal Growth Dynamics | July 2026 YouTube Long-Form Script Pack
"""
...
INPUT_MD   = os.path.join(BASE_DIR, "lgd-family-law-attorneys_july-2026-youtube-scripts_20260305.md")
OUTPUT_DOCX = os.path.join(BASE_DIR, "lgd-family-law-attorneys_july-2026-youtube-scripts_20260305.docx")
...
def add_cover_page(doc):
    ...
    run = cover_title.add_run('22-DAY YOUTUBE LONG-FORM SCRIPT PACK')
    ...
    r2 = sub.add_run('Family Law Attorneys | July 2026')
    ...
    for line in [
        '22 Complete Long-Form Scripts  |  5-Week Belief-to-Buy Arc',
