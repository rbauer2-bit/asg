...
Legal Growth Dynamics | June 2026 YouTube Long-Form Script Pack
"""
...
INPUT_MD   = os.path.join(BASE_DIR, "lgd-family-law-attorneys_june-2026-youtube-30day-scripts_20260305.md")
OUTPUT_DOCX = os.path.join(BASE_DIR, "lgd-family-law-attorneys_june-2026-youtube-30day-scripts_20260305.docx")
...
def add_cover_page(doc):
    ...
    r2 = sub.add_run('Family Law Attorneys | June 2026')
    ...
    for line in [
        '21 Complete Long-Form Scripts  |  5-Week Belief-to-Buy Arc',
