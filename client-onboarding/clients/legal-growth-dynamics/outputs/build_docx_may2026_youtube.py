...
Legal Growth Dynamics — May 2026 YouTube Long-Form Script Pack
"""
...
INPUT_MD = "client-onboarding/clients/legal-growth-dynamics/outputs/lgd-family-law-attorneys_may-2026-youtube-longform-scripts_20260305.md"
OUTPUT_DOCX = "client-onboarding/clients/legal-growth-dynamics/outputs/lgd-family-law-attorneys_may-2026-youtube-longform-scripts_20260305.docx"

CLIENT_NAME = "Legal Growth Dynamics"
CLIENT_SUBTITLE = "Family Law Attorney Market"
DOCUMENT_TITLE = "30-DAY YOUTUBE LONG-FORM SCRIPT PACK"
DOCUMENT_SUBTITLE = "May 2026 — 21 Complete Scripts"
MONTH_YEAR = "May 2026"
...
def parse_and_render(doc, md_path):
    ...
    while i < len(lines):
        ...
        # Skip the markdown header block (first --- separator marks end of cover material)
        if not cover_done:
            if line.strip() == '---':
                cover_done = True
            i += 1
